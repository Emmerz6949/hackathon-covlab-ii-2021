...
class Chem extends Component {
    ...
    renderStep = () => {
        ...
        else if (this.state.hotPlate === false && this.state.heated === false && this.state.pink === false) {
            return(
                <Step
                    imgSrc={Clear}
                    imgStylin={styles.imgStyle}
                    ...
                    pText={steps[3].pText}
                    handleContinue={this.handleContinue3}
                    btnText={"Continue"}
                />
            );
        }
        ...
        return(
            <main>
                <div className="mx-auto mt-5 bg" style={styles.divStyle}>
                    ...
                    <p className="fw-bold">
                        This experiment utilizes a hot plate, and a solution made up of 500ml of water, a drop of concentrated ammonia,
                         and a few drops of phenolphthalein. At room temperature the solution will be pink due to the pH of the concentrated ammonia.
                    </p>
                    {this.renderStep()}
                </div>
            </main>
