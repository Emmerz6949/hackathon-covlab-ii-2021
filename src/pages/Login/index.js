        ...
        <main>
            <div className="mx-auto mt-5 bg" style={styles.divStyle}>
                ...
                <form className="signup">
                    ...
                    <h5 className="btn fs-5 border-dark border-3 rounded-pill bg mt-3"><Link to="/science-rific-labs/choose" className="text-decoration-none text-reset">Login</Link></h5>
                </form>
                <h5>or</h5>
                <h5 className="btn fs-5 border-dark border-3 rounded-pill bg"><Link to="/science-rific-labs/sign-up" className="text-decoration-none text-reset">Sign Up</Link></h5>
            </div>
        </main>
    );
}
